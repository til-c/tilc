use tilc_ast::{
  Attribute, AttributeStyle, Expression, Local, LocalKind, Mutability, NodeIdx,
  Statement, StatementKind, TokenKind,
};
...
impl<'a> Parser<'a> {
  ...
  fn parse_initializer(&mut self) -> PResult<'a, Option<Box<Expression>>> {
